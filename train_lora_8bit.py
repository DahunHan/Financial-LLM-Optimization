...
trainer = Trainer(
    ...
    # to properly batch the data. We will add this in the next step. Step by step
)

print("\nSetup Complete. Ready to rock and roll")
# We are just confirming that all components load and initialize \
# The actual command to start training will be added next.